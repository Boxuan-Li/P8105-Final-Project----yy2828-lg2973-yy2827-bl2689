...
### Objectives
There are some points expected to be explored in this study.

* Basic description and operation on variables within the dataset. 
* Review of the connection of the popularity of a TED talk with other varibales and exploration of what makes a TED talk popular.
