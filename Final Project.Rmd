...
speaker %>% 
  ...
  coord_flip() +
  labs(
    title = "visualization of the ten top speaker occupation",
    x = "main speaker",
    y = "number of talks"
  )
